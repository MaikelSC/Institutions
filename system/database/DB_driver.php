		...
		if (FALSE === ($this->result_id = $this->simple_query($sql)))
		{
			...
			if ($this->db_debug)
			{
				...
				return $this->display_error(
										array(
												'N&uacute;mero de error: '.$error_no,
												$error_msg,
												$sql
											)
										);
	...
	function display_error($error = '', $swap = '', $native = FALSE)
	{
		...
		foreach ($trace as $call)
		{
			if (isset($call['file']) && strpos($call['file'], BASEPATH.'database') === FALSE)
			{
				...
				$message[] = 'Nombre de archivo: '.str_replace(array(BASEPATH, APPPATH), '', $call['file']);
				$message[] = 'N&uacute;mero de linea: '.$call['line'];
...
//		include(APPPATH.'controllers/c_admin.php');
//		print_r($message[0]);
//		$admin = new c_admin();
//		$admin->setMensaje($message);
