...
<table  border="0" id="cuerpo" >	
  ...
  <tr><td colspan="2"> <div id="tbodyAdmin">
		  ...
		  <tr>
			 <td colspan="2" id="cuerpoInt"><!-- InstanceBeginEditable name="EditCuerpo" --><div style="height:450px;">Esta es la pagina de bienvenida para el Administrador</div><!-- InstanceEndEditable --></td>
		  </tr>
  </table>
  </div>
  </td>
